...
$sql = "SELECT * FROM products WHERE category = 'kaapelit'";
...
<div class="content">
    <center><h2>Saatavilla olevat laturit ja kaapelit</h2></center>
...
<div id="enlargedView" class="enlarged">
    ...
    <div class="enlarged-content">
        ...
        <div class="enlarged-info">
            ...
            <p id="productPrice"></p> <!-- Add this line for displaying price -->
        </div>
    </div>
</div>
